    ...
    <section>
            <div className="container py-8">
                ...
                { ( !loginStatus.success && loginStatus.message ) && <p className="text-sm text-red-500 italic">{loginStatus.message}</p> }
                    ...
                    <GoogleLogin
                        clientId="534881044780-4fpj180t5nog731beeld6btuu18rbuvk.apps.googleusercontent.com"
                        render={ props => {
                            return (
                                <button className="bg-red-500 text-white rounded mt-2 px-8 py-3" onClick={props.onClick} disabled={props.disabled}>
                                    Login with Google
                                </button>
                            )
                        }}
